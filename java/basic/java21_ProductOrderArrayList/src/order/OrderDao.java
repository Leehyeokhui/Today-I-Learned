...
public interface OrderDao {
	...
	ArrayList<Order> selectAll();// 주문목록
	...
	ArrayList<Order> selectByPayFalse();// 결제대상. pay_result가 false인 것만 검색해서 반환

	ArrayList<Order> selectByOutFalse();// 출고대상. out_result가 false이고 pay_result가 true인 것만 검색해서 반환
}
